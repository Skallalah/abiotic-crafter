...
- Barre de catégories sous la recherche : un bouton-icône par catégorie présente chez les craftables, plus « All » (le défaut). Icônes SVG monochromes dessinées main (le wiki n'a pas d'images de catégorie), peintes dans `--logo-ink` — noires en Windows 98, ambre en Modern Slop, comme l'arche GATE. Le filtre est additif (catégorie ∩ recherche ∩ zones découvertes), l'intertitre du groupe reste affiché en vue mono-catégorie, « Divers » ferme la rangée, et le choix persiste (`gate-crafting-index/category`, assaini contre le dataset).
